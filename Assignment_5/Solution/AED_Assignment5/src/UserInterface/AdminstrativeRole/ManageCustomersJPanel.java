...
public class ManageCustomersJPanel extends javax.swing.JPanel {
    ...
    public ManageCustomersJPanel(JPanel userProcessContainer, CustomerDirectory customerDirectory) {
        initComponents();
    ...
    private void addCustomerJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCustomerJButtonActionPerformed
        ...
        AddCustomer acjp= new AddCustomer(userProcessContainer,customerDirectory);
    ...
    private void removeCustomerJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeCustomerJButtonActionPerformed
        ...
        int flag= JOptionPane.showConfirmDialog(this, "Are you sure want to remove this customer?","Warning", JOptionPane.YES_NO_OPTION);
        if(flag==0)
        {
